...
model_name = 'liniear_regression.joblib.pkl'
...
def main():
    ...
    lin_reg = train_model(data_train.data , data_train.label_class)

    predicted = lin_reg.predict(data_train.data)
    ...
    print(predicted)
    print(lin_reg.score(data_train.data , data_train.label_class))
